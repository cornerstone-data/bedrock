...
def column_names(file_name):
    ...
    pacific_region = [
        '5d407318e4b01d82ce8d9b3c?f=__disk__22%2F5c%2Fe3%2F225'
    ...
    midwestern = [
        '5cbf5150e4b09b8c0b700df3?f=__disk__66%2F4f%2Ff2%2F664ff289'
    ...
    northeastern = [
        '5d4192aee4b01d82ce8da477?f=__disk__c2%2F02%2F06%2Fc202060'
    ...
    southwestern = [
        '5f8f1f1282ce06b040efc90e?f=__disk__f8%2Fb8%2Ff9%2Ff8b8f9'
    ...
    southeastern = [
        '5d6e70e5e4b0c4f70cf635a1?f=__disk__fb%2Fdb%2F92%2Ffbdb928'
...
def sparrow_call(*, resp, url, **_):
    ...
    ph = [
        '5cbf5150e4b09b8c0b700df3?f=__disk__bf%2F73%2F1f%2Fbf731fdf4e984'
    ...
    ni = [
        '5cbf5150e4b09b8c0b700df3?f=__disk__66%2F4f%2Ff2%2F664ff289064560bb'
    ...
    comid_cap = [
        "5f8f1f1282ce06b040efc90e?f=__disk__8e%2F8e%2Fb8%2F8e8eb8203e"
    ...
    if (
        "5d407318e4b01d82ce8d9b3c?f=__disk__2b%2F75%2F2b%2F2b752b0c5decf8e83"
    ...
    df = df_raw.melt(
        id_vars=["comid"], var_name="ActivityProducedBy", value_name="FlowAmount"
    )
    df = df.rename(columns={"comid": "Location"})

    df_spread = df_spread.melt(
        id_vars=["comid"], var_name="spread_name", value_name="Spread"
    )
    ...
    df_no_spread = df_no_spread.melt(
        id_vars=["comid"], var_name="ActivityProducedBy", value_name="FlowAmount"
    )
    ...
    df = pd.merge(
        df,
        df_spread,
        left_on=["ActivityProducedBy", "Location"],
