...
_RAW_MAKE_INTERSECTION = {
    # (industry, commodity): raw CSV PercentMake (after redefinition BEA tables)
    ("562111", "562111"): 4.23e-01,
    ("562HAZ", "562HAZ"): 1.50e-01,
    ("562212", "562212"): 7.90e-02,
    ("562213", "562213"): 1.31e-02,
    ("562910", "562910"): 1.68e-01,
    ("562920", "562920"): 5.26e-02,
    ("562OTH", "562OTH"): 1.14e-01,
}

_RAW_MAKE_COL_SUM = {
    # (industry, commodity): raw CSV PercentMake — "Make column sum" + "commodity disaggregation" (after redefinition)
    ("562000", "562111"): 4.79e-01,
    ("562000", "562HAZ"): 1.28e-01,
    ("562000", "562212"): 8.15e-02,
    ("562000", "562213"): 1.35e-02,
    ("562000", "562910"): 1.46e-01,
    ("562000", "562920"): 5.42e-02,
    ("562000", "562OTH"): 9.76e-02,
    ("484000", "562111"): 1.00e00,
    ("561700", "562910"): 1.00e00,
    ("GSLGO", "562111"): 7.62e-01,
    ("GSLGO", "562212"): 1.30e-01,
    ("GSLGO", "562213"): 2.15e-02,
    ("GSLGO", "562920"): 8.63e-02,
}

_RAW_MAKE_INDUSTRY_ROWS = {
    # (industry, commodity): raw CSV PercentMake — "industry disaggregation" rows (after redefinition: only 211000)
...
_RAW_USE_VA = {
    # VA disaggregation: IndustryCode=waste subsector, CommodityCode=V00100/V00200/V00300 (after redefinition)
    ("562111", "V00100"): 4.58e-01,
    ("562HAZ", "V00100"): 2.09e-02,
    ("562212", "V00100"): 8.05e-02,
    ("562213", "V00100"): 1.38e-02,
    ("562910", "V00100"): 2.05e-01,
    ("562920", "V00100"): 7.10e-02,
    ("562OTH", "V00100"): 1.51e-01,
    ("562111", "V00200"): 4.58e-01,
    ("562HAZ", "V00200"): 2.09e-02,
    ("562212", "V00200"): 8.05e-02,
    ("562213", "V00200"): 1.38e-02,
    ("562910", "V00200"): 2.05e-01,
    ("562920", "V00200"): 7.10e-02,
    ("562OTH", "V00200"): 1.51e-01,
    ("562111", "V00300"): 4.58e-01,
    ("562HAZ", "V00300"): 2.09e-02,
    ("562212", "V00300"): 8.05e-02,
    ("562213", "V00300"): 1.38e-02,
    ("562910", "V00300"): 2.05e-01,
    ("562920", "V00300"): 7.10e-02,
    ("562OTH", "V00300"): 1.51e-01,
}
