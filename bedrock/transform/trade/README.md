...
- **Import `MISS` >= 1 B USD besides `S00300`.** `221100` (2,431 M), `561300` employment services (1,588 M). Same rule. (`311810` and `1121A0` are filled from `31181X` / `11211X` or `1121XX`.)
