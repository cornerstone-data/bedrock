...
def load_yaml_dict(filename, flowbytype=None, filepath=None, **kwargs):
    ...
    if re.search(pattern, filename):
        log.warning(
            'Filename includes a github version and githash. Dropping '
...
fba_activity_fields = [
    activity_fields['ProducedBy'][0]['flowbyactivity'],
    activity_fields['ConsumedBy'][0]['flowbyactivity'],
]
fbs_activity_fields = [
    activity_fields['ProducedBy'][1]['flowbysector'],
