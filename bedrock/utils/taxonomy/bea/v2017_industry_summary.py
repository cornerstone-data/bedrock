...
BEA_2017_INDUSTRY_SUMMARY_CODE = ta.Literal[
    "111CA",  # Farms
...
BEA_2017_INDUSTRY_SUMMARY_CODES: ta.List[BEA_2017_INDUSTRY_SUMMARY_CODE] = list(
    ta.get_args(BEA_2017_INDUSTRY_SUMMARY_CODE)
)

BEA_2017_INDUSTRY_SUMMARY_CODE_DESC: ta.Dict[BEA_2017_INDUSTRY_SUMMARY_CODE, str] = {
    # order matters!
    "111CA": "Farms",
    "113FF": "Forestry, fishing, and related activities",
    "211": "Oil and gas extraction",
...
USA_2017_SUMMARY_INDUSTRY_DESC = BEA_2017_INDUSTRY_SUMMARY_CODE_DESC
USA_2017_SUMMARY_INDUSTRY_CODES = BEA_2017_INDUSTRY_SUMMARY_CODES
