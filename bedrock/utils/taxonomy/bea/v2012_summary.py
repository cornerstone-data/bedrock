...
BEA_2012_SUMMARY_CODE = ta.Literal[
    "111CA",  # Farms
...
BEA_2012_SUMMARY_CODES: ta.List[BEA_2012_SUMMARY_CODE] = list(
    ta.get_args(BEA_2012_SUMMARY_CODE)
)

BEA_2012_SUMMARY_CODE_DESC: ta.Dict[BEA_2012_SUMMARY_CODE, str] = {
    "111CA": "Farms",
    "113FF": "Forestry, fishing, and related activities",
    "211": "Oil and gas extraction",
    "212": "Mining, except oil and gas",
