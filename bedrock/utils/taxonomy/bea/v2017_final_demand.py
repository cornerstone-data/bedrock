...
USA_2017_FINAL_DEMAND_DESC = {
    # from GCS_EXTRACT_INPUT_DIR/USA_AllTablesSUP/Use_SUT_Framework_2017_DET.xlsx
    # order matters!
...
USA_2017_FINAL_DEMAND_CODES = list(USA_2017_FINAL_DEMAND_DESC.keys())
...
BEA_2017_FINAL_DEMAND_CODES = USA_2017_FINAL_DEMAND_CODES
BEA_2017_FINAL_DEMAND_CODE_DESC: ta.Dict[BEA_2017_FINAL_DEMAND_CODE, str] = USA_2017_FINAL_DEMAND_DESC  # type: ignore
USA_2017_FINAL_DEMAND_PERSONAL_CONSUMPTION_EXPENDITURE_CODE = "F01000"
USA_2017_FINAL_DEMAND_EXPORT_CODE = "F04000"
USA_2017_FINAL_DEMAND_IMPORT_CODE = "F05000"

# Use SUT framework has no imports column; F05000 is MUT-only.
SUT_FINAL_DEMAND_CODES = tuple(c for c in USA_2017_FINAL_DEMAND_CODES if c != "F05000")
