...
BEA_2012_INDUSTRY_CODE = ta.Literal[
...
BEA_2012_INDUSTRY_CODES: ta.List[BEA_2012_INDUSTRY_CODE] = list(
    ta.get_args(BEA_2012_INDUSTRY_CODE)
)

BEA_2012_INDUSTRY_CODE_DESC: ta.Dict[BEA_2012_INDUSTRY_CODE, str] = {
    # ... (already there)
}

USA_2012_INDUSTRY_DESC = BEA_2012_INDUSTRY_CODE_DESC
USA_2012_INDUSTRY_CODES = BEA_2012_INDUSTRY_CODES
