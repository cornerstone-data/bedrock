...
https://apps.bea.gov/histdata/histChildLevels.cfm?HMI=8
    > 2018, Q2 (release of 2012 benchmarking tables)
    > AllTables.zip
    > IOMake_After_Redefinitions_2007_2012_Detail.xlsx
    > 2012
"""

import typing as ta

BEA_2012_COMMODITY_CODE = ta.Literal[
...
BEA_2012_COMMODITY_CODES: ta.List[BEA_2012_COMMODITY_CODE] = list(
    ta.get_args(BEA_2012_COMMODITY_CODE)
)

BEA_2012_COMMODITY_CODE_DESC: ta.Dict[BEA_2012_COMMODITY_CODE, str] = {
    "1111A0": "Oilseed farming",
    "1111B0": "Grain farming",
    "111200": "Vegetable and melon farming",
    "111300": "Fruit and tree nut farming",
...
USA_2012_COMMODITY_DESC = BEA_2012_COMMODITY_CODE_DESC
USA_2012_COMMODITY_CODES = BEA_2012_COMMODITY_CODES
