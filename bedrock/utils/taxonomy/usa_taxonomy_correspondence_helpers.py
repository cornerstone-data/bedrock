...
@functools.cache
def load_usa_2017_commodity__cornerstone_commodity_correspondence() -> pd.DataFrame:
    return create_correspondence_matrix(
        load_bea_v2017_commodity_to_cornerstone_commodity(),  # type: ignore
...
@functools.cache
def load_usa_2017_industry__cornerstone_industry_correspondence() -> pd.DataFrame:
    return create_correspondence_matrix(
        load_bea_v2017_industry_to_cornerstone_industry(),  # type: ignore
...
def load_ceda_v7_commodity__cornerstone_commodity_correspondence() -> pd.DataFrame:
    return create_correspondence_matrix(
        load_ceda_v7_commodity_to_cornerstone_commodity(),  # type: ignore
