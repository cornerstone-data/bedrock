...
| `compare_sef_margins_sources.py` | Margin SEF side-by-side: Zenodo v1.4.0, `useeio_phoebe_23`, `2025_usa_cornerstone_v0_3` (2024 purchaser) → `output/sef_margins_zenodo_phoebe_v0_3.csv` |
...
SEF scripts publish at the target dollar year when no CSV path is passed (e.g.
`--dollar_year 2024`). Purchaser Phi uses useeior-style Rho margin inflation when
