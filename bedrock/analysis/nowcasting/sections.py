...
SUPPLY_OUTPUT_DETAIL_SUT = Section(
    ...
    note=(
        ...
        'commodities, not 402. Quote a difference only over present cells. '
        '2017 runs at 99.98% coverage, a median difference of 0.96% and 0.81% '
        'value-weighted - 5,079 cells present on both sides, 1 miss and no '
        'extras, of 5,080 (re-measured 2026-09-08). '
