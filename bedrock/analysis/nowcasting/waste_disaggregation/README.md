...
[`.cursor/plans/waste_disagg_three_phases_18d3c084.plan.md`](../../../../.cursor/plans/waste_disagg_three_phases_18d3c084.plan.md)
— Phase 1 status, locked decisions, Phase 2 A–C (2024 pilot), and Phase 3 (multi-year).
...
| [`impact_nowcast_updated_weights.md`](impact_nowcast_updated_weights.md) | Phase 2 C impact report |
...
- Phase 2 A–C (2024): **done** — treatment YAML + derive path + EC 2022 + BR RCRA + impact report
- Phase 3 (2018–2023 / production flip): **blocked** until after 2024 impact review