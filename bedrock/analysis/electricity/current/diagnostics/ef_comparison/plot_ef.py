"""Plot N/D EF diagnostics for electricity disagg steps vs Cornerstone v0.3.1 footing."""
...
from bedrock.analysis.electricity.current.diagnostics.local_workbooks import (
    EF_TABS,
    REQUIRED_TABS,
    seed_cache_from_local_dir,
)
from bedrock.analysis.electricity.current.diagnostics.manifest import load_manifest
...
SUPTITLE = 'vs Cornerstone v0.3.1 electricity footing'
...
def write_panel_pngs(
    ...
    for ef_kind, col in (('N', 'N_perc_diff'), ('D', 'D_perc_diff')):
        ...
        # Live write path. Published original / pre-MECS panels live in
        # historical/original_vs_eia_anchored_deck/figures/.
...
def run_plot_ef(*, local_dir: Path) -> Path:
    ...
    for step in manifest.steps:
        ...
        print(f'=== Plot {label} ({slug}) vs v0.3.1 electricity footing ===')
    ...
    print('=== Panel N/D vs v0.3.1 electricity footing ===')
