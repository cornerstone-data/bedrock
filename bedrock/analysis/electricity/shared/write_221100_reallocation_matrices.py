...
Invoke as::
    ...
    uv run python -m bedrock.analysis.electricity.shared.write_221100_reallocation_matrices \\
...
from bedrock.analysis.electricity.shared.reallocation_matrices import (
