"""Check ``egrid_to_sector`` FBS totals vs stewi eGRID US national tab.
    ...
    uv run python -m bedrock.analysis.electricity.shared.verify_egrid_to_sector_vs_national
    uv run python -m bedrock.analysis.electricity.shared.verify_egrid_to_sector_vs_national 2022
