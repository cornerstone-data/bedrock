...
from ceda_usa.extract.allocation.epa_constants import (
    EPA_TABLE_NAME_TO_TABLE_NUMBER_MAP_2022,
    EPA_TABLE_NAME_TO_TABLE_NUMBER_MAP_2023,
    EPA_TABLE_NAMES,
    TBL_NUMBERS,
)
from ceda_usa.transform.allocation.utils import parse_index_with_aggregates
from ceda_usa.utils.gcp import GCS_CEDA_INPUT_DIR, load_from_gcs
from ceda_usa.utils.gwp import derive_ar5_to_ar6_multiplier
