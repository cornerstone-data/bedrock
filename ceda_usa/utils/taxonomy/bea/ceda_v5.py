...
# NOTE: subset of bea v2012 codes...
# In [9]: set(BEA_2012_COMMODITY_CODES) - set(CEDA_CODES)
# Out[9]: {'33131B', 'S00402', 'S00401', 'S00300', 'S00900'}

# In [10]: set(CEDA_CODES) - set(BEA_2012_COMMODITY_CODES)
# Out[10]: set()

CEDA_V5_SECTOR = ta.Literal[
    ...
    "331313",  # "Alumina refining and primary aluminum production + Aluminum product manufacturing from purchased aluminum",
    ...
    "332200",  # "Cutlery and hand tool manufacturing",
...
CEDA_V5_SECTORS: ta.List[CEDA_V5_SECTOR] = list(ta.get_args(CEDA_V5_SECTOR))


CEDA_V5_SECTOR_DESC: ta.Dict[CEDA_V5_SECTOR, str] = {
    "1111A0": "Oilseed farming",
    "1111B0": "Grain farming",
    "111200": "Vegetable and melon farming",
    "111300": "Fruit and tree nut farming",
