...
# NOTE: not == bea v2017 codes...
# In [9]: set(BEA_2017_COMMODITY_CODES) - set(CEDA_V7_SECTORS)
# Out[9]: {'33131B', '335220', 'S00300', 'S00401', 'S00402', 'S00900'}

# In [10]: set(CEDA_V7_SECTORS) - set(BEA_2017_COMMODITY_CODES)
# Out[10]: {'335221', '335222', '335224', '335228'}

CEDA_V7_SECTOR = ta.Literal[
...
CEDA_V7_SECTORS: ta.List[CEDA_V7_SECTOR] = list(ta.get_args(CEDA_V7_SECTOR))

CEDA_V7_SECTOR_DESC: ta.Dict[CEDA_V7_SECTOR, str] = {
    "1111A0": "Oilseed farming",
    "1111B0": "Grain farming",
    "111200": "Vegetable and melon farming",
    "111300": "Fruit and tree nut farming",
